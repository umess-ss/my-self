    ...
    <article className="min-h-screen bg-white dark:bg-gray-900 pt-28 pb-20 transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mt-16 pt-8 border-t border-gray-100 dark:border-gray-800">
          <h4 className="font-bold text-gray-900 dark:text-white mb-2">Enjoyed this post</h4>
          <p className="text-gray-500 dark:text-gray-400">Feel free to reach out via the contact section on the home page!</p>
        </div>
      </div>
    </article>
  );
