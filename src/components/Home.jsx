...
export default function Home() {
  return (
    <section id="home" className="min-h-screen flex items-center from-gray-50 to-gray-200 dark:from-gray-800 dark:to-gray-900 pt-20 transition-colors duration-300">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">{personalInfo.title}</p>
