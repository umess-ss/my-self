...
import { FadeContent, MagicRings, PixelTransition, ScrollFloat, ScrollReveal } from "@/components/ui/MotionEffects";
...
<ScrollFloat className="mb-6 max-w-[30rem]">
  <h1 className="text-[clamp(2.15rem,4vw,3.35rem)] font-extrabold leading-[1.05] tracking-[-0.04em] text-[var(--portfolio-text)] md:whitespace-nowrap">
    Umesh Rajbanshi
  </h1>
</ScrollFloat>
            ...
            <FadeContent className="mb-9 max-w-[37rem]">
            ...
            <FadeContent className="mt-12 border-t border-[var(--portfolio-border)] pt-6">
          ...
          <div className="overflow-visible">
            <div className="flex justify-center overflow-visible lg:justify-start">
              <div className="hero-portrait-shell group relative grid place-items-center overflow-visible">
                ...
                <PixelTransition className="relative z-10">
                  <Image
